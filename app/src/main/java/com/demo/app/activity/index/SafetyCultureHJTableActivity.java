...
public class SafetyCultureHJTableActivity extends BaseActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exist_dm_dj_tables = (Button) this.findViewById(R.id.exist_sc_hj_tables);
        new_dm_dj_tables = (Button) this.findViewById(R.id.new_sc_hj_tables);
        exist_dm_dj_tables.setOnClickListener(this);
        new_dm_dj_tables.setOnClickListener(this);
        dmDjTablesListView = (ListView) this.findViewById(R.id.schjTablesListView);
        ...
        dmDjTablesListView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                ...
                if (Integer.parseInt(data.get(arg2).get("seeItemAuth").toString()) == 0) {
                    Toast.makeText(SafetyCultureHJTableActivity.this, "对不起，权限不足，请联系管理员!", Toast.LENGTH_SHORT).show();
                    return;
                }
                Intent i = new Intent();
                ...
                i.setClass(SafetyCultureHJTableActivity.this, SafetyCultureHJListShowActivity.class);
                startActivity(i);
            }
        });
    }
    ...
    public List<Map<String, Object>> getData() {
        ...
        data.clear();
        NetworkData.getInstance().environmentalInspectionList(new NetworkResponceFace() {
...
//					result = URLDecoder.decode(result,"utf-8");
    ...
    public void onClick(View v) {
        // TODO Auto-generated method stub
        switch (v.getId()) {
            case R.id.exist_sc_hj_tables:
                new_dm_dj_tables.setBackgroundResource(R.drawable.button_franchise_shape1);
                exist_dm_dj_tables.setBackgroundResource(R.drawable.button_franchise_shape);
                break;
            case R.id.new_sc_hj_tables:
                ...
                Intent i = new Intent();
                i.setClass(SafetyCultureHJTableActivity.this, SafetyCultureHJActivity.class);
                startActivity(i);
                break;
            default:
                break;
