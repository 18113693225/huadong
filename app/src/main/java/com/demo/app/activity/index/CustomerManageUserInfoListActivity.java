...
//客户经理用户信息活动列表
public class CustomerManageUserInfoListActivity extends BaseActivity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentViewWithoutTitle(R.layout.index_customer_manager_userinfo_list_layout);
		TitleCommon.setTitle(this,null, "用户信息反馈表", CustomerManagerActivity.class,true);
		sp = getSharedPreferences(Constents.SHARE_CONFIG, Context.MODE_PRIVATE);
		exist_workconnect_tables = (Button) this.findViewById(R.id.exist_cm_userinfo_tables);
		new_workconnect_tables = (Button) this.findViewById(R.id.new_cm_userinfo_tables);
		exist_workconnect_tables.setOnClickListener(this);
		new_workconnect_tables.setOnClickListener(this);
		pmWorkconnectTablesListView = (ListView)this.findViewById(R.id.cmUserinfoTablesListView);
		...
		pmWorkconnectTablesListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				if(Integer.parseInt(data.get(arg2).get("seeItemAuth").toString())==0){
					Toast.makeText(CustomerManageUserInfoListActivity.this, "对不起，权限不足，请联系管理员!", Toast.LENGTH_SHORT).show();
					return;
				}
				...
				i.setClass(CustomerManageUserInfoListActivity.this, CustomerManagerUserInfoShowActivity.class);
				startActivity(i);
			}
		});
	}
	...
	public List<Map<String, Object>> getData() {
		...
		data.clear();
		NetworkData.getInstance().custInfoBackList(new NetworkResponceFace() {
...
//					result = URLDecoder.decode(result,"utf-8");
	...
	public void onClick(View v) {
		// TODO Auto-generated method stub
		switch (v.getId()) {
		case R.id.exist_cm_userinfo_tables:
			new_workconnect_tables.setBackgroundResource(R.drawable.button_franchise_shape1);
			exist_workconnect_tables.setBackgroundResource(R.drawable.button_franchise_shape);
			break;
		case R.id.new_cm_userinfo_tables:
			...
			Intent i = new Intent();
			i.setClass(CustomerManageUserInfoListActivity.this, CustomerManagerUserInfoActivity.class);
			startActivity(i);
			break;
		default:
			break;
