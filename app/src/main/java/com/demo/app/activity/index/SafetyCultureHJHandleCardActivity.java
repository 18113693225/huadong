...
public class SafetyCultureHJHandleCardActivity extends BaseActivity {
    ...
    private Handler handler = new Handler() {
        public void handleMessage(android.os.Message msg) {
            if (msg.what == 0) {
                ...
                Toast.makeText(SafetyCultureHJHandleCardActivity.this, "保存成功", Toast.LENGTH_LONG).show();
                SafetyCultureHJHandleCardActivity.this.finish();
            } else if (msg.what == 2) {
                Toast.makeText(SafetyCultureHJHandleCardActivity.this, "保存失败", Toast.LENGTH_LONG).show();
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (pwm != null) {
            TitleCommon.setTitle(this, null, "环境检查巡视卡", PersonWorkManagerActivity.class, true);
        } else {
            TitleCommon.setTitle(this, null, "环境检查巡视卡", SafetyCultureHJShowActivity.class, true);
        }
        TitleCommon.setGpsTitle(this);
        oper_id = getIntent().getStringExtra("oper_id");
        oper_type = getIntent().getStringExtra("oper_type");
        lid = getIntent().getStringExtra("lid");
        commonLayout = (LinearLayout) this.findViewById(R.id.sc_hj_jx_commonLayout);
        pname = (CustomeEditText2) this.findViewById(R.id.sc_hj_jx_pname);
        ptype = (CustomeEditText2) this.findViewById(R.id.sc_hj_jx_ptype);
        runit = (CustomeEditText2) this.findViewById(R.id.sc_hj_jx_runit);
        xsr = (CustomeEditText2) this.findViewById(R.id.sc_hj_jx_xsr);
//		safetyselect = (CustomeEditText2)this.findViewById(R.id.sc_hj_jx_safetyselect);
        ttime = (TextView) this.findViewById(R.id.title_gps_time);
        taddress = (TextView) this.findViewById(R.id.title_gps_address);
        jxlog = (EditText) this.findViewById(R.id.sc_hj_jx_jxlog);
        saveBtn = (Button) this.findViewById(R.id.sc_hj_jx_saveBtn);
        ...
        if (getIntent().getStringExtra("data") == null) {
            ...
            findViewById(R.id.sc_hj_jx_end).setVisibility(View.INVISIBLE);
        } else {//电力运行检修任务
...
//		qx.setValueText(bean.getDefect_type());
        ...
        xscontentBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("type", 4 + "");
                i.setClass(SafetyCultureHJHandleCardActivity.this, DXSBXSKContentShowListActivity.class);
                startActivity(i);
            }
        });
