...
//客户经理工作连接活动列表
public class CustomerManageWorkConnectListActivity extends BaseActivity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		exist_workconnect_tables = (Button) this.findViewById(R.id.exist_cm_workconnect_tables);
		new_workconnect_tables = (Button) this.findViewById(R.id.new_cm_workconnect_tables);
		exist_workconnect_tables.setOnClickListener(this);
		new_workconnect_tables.setOnClickListener(this);
		pmWorkconnectTablesListView = (ListView)this.findViewById(R.id.cmWorkconnectTablesListView);
		...
		pmWorkconnectTablesListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				if(Integer.parseInt(data.get(arg2).get("seeItemAuth").toString())==0){
					Toast.makeText(CustomerManageWorkConnectListActivity.this, "对不起，权限不足，请联系管理员!", Toast.LENGTH_SHORT).show();
					return;
				}
				...
				i.setClass(CustomerManageWorkConnectListActivity.this, CustomerManagerWorkConnectTicketShowActivity.class);
				startActivity(i);
			}
		});
	}
	...
	public List<Map<String, Object>> getData() {
		...
		data.clear();
		NetworkData.getInstance().workContackList(new NetworkResponceFace() {
...
//					result = URLDecoder.decode(result,"utf-8");
	...
	public void onClick(View v) {
		// TODO Auto-generated method stub
		switch (v.getId()) {
		case R.id.exist_cm_workconnect_tables:
			new_workconnect_tables.setBackgroundResource(R.drawable.button_franchise_shape1);
			exist_workconnect_tables.setBackgroundResource(R.drawable.button_franchise_shape);
			break;
		case R.id.new_cm_workconnect_tables:
			...
			Intent i = new Intent();
			i.setClass(CustomerManageWorkConnectListActivity.this, CustomerManagerWorkConnectTicketActivity.class);
			startActivity(i);
			break;
		default:
			break;
