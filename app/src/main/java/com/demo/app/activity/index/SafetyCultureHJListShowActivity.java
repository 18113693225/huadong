...
public class SafetyCultureHJListShowActivity extends BaseActivity implements View.OnClickListener{
	...
	private Handler handler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			...
			case 1:
				...
				break;
			case 2:
				Toast.makeText(SafetyCultureHJListShowActivity.this, "删除成功！",Toast.LENGTH_SHORT).show();
				finish();
				break;
			case 3:
				Toast.makeText(SafetyCultureHJListShowActivity.this, "删除失败",Toast.LENGTH_SHORT).show();
				break;
			default:
				break;
			}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.index_safety_culture_hj_xsklist_show_layout);
		...
		commonLayout = (LinearLayout)this.findViewById(R.id.common_sc_hj_xsk_show_linearlayout);
		...
		pname = (CustomeTextView) this.findViewById(R.id.sc_hj_show_pname);
		ptype = (CustomeTextView) this.findViewById(R.id.sc_hj_show_ptype);
		runit = (CustomeTextView) this.findViewById(R.id.sc_hj_show_runit);
		xsr = (CustomeTextView) this.findViewById(R.id.sc_hj_show_xsr);
//		safetyselect = (CustomeTextView) this.findViewById(R.id.sc_hj_show_safetyselect);
		
		delete_oper_tables = (Button) this.findViewById(R.id.delete_sc_hj_tables);
		delete_oper_tables.setOnClickListener(this);
		edit_oper_tables = (Button) this.findViewById(R.id.edit_sc_hj_tables);
		edit_oper_tables.setOnClickListener(this);
		/*deviceJxBtn = (Button) this.findViewById(R.id.deviceHjScBtn);
		deviceJxBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				i.putExtra("lid", lid);
				i.setClass(SafetyCultureHJListShowActivity.this,SafetyCultureHJHandleCardActivity.class);
				startActivity(i);
			}
		});*/
		getData(p_id);
...
//		int uid = sp.getInt("userId", -1);
		NetworkData.getInstance().environmentalInspectionBean(
	...
	public void addDevice(final EnvironmentalInspectionBean bean){
		lid = bean.getId()+"";
...
//		safetyselect.setValueText(bean.getEnvironmental_options());
...
//		qx.setValueText(bean.getDefect_type());
		...
		xscontentBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				i.putExtra("type", 4+"");
				i.setClass(SafetyCultureHJListShowActivity.this, DXSBXSKContentShowListActivity.class);
				startActivity(i);
			}
		});
	...
	public void onClick(View v) {
		// TODO Auto-generated method stub
		switch (v.getId()) {
		case R.id.delete_sc_hj_tables:
			if (getIntent().getIntExtra("editAuth", 1) == 0
					|| getIntent().getIntExtra("editListAuth", 1) == 0
					|| getIntent().getIntExtra("editItemAuth", 1) == 0) {
				Toast.makeText(SafetyCultureHJListShowActivity.this,"对不起，权限不足，请联系管理员!", Toast.LENGTH_SHORT).show();
				return;
			}
			...
			final AlertDialog alertDialog = new AlertDialog.Builder(
					SafetyCultureHJListShowActivity.this).create();
			alertDialog.show();
			...
			okBtn.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
					NetworkData.getInstance().environmentalInspectionDelete(
							new NetworkResponceFace() {
