        ...
        if (ce.getTag().equals("pr_new_dnum")) {
            bt.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (LBs.size() < btId + 1) {
                        Toast.makeText(SafetyCultureHJActivity.this, "请选择设备类别，相同的设备不能重复添加！,", Toast.LENGTH_SHORT).show();
                        return;
                    } else {
                        Intent i = new Intent();
                        ...
                        i.setClass(SafetyCultureHJActivity.this, DXSBXSKContentListActivity.class);
                        i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        SafetyCultureHJActivity.this.startActivity(i);
                    }
                }
            });
        }
