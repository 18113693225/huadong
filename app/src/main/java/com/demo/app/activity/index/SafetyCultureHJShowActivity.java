...
public class SafetyCultureHJShowActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.index_safety_culture_hj_xsk_show_layout);
		getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_HIDDEN);
		TitleCommon.setTitle(this, null, "环境检查巡视卡",PowerRunJXTaskListActivity.class, true);
...
//		safetyselect = (CustomeTextView) this.findViewById(R.id.sc_hj_show_safetyselect);
		...
		deviceJxBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				i.putExtra("lid", lid);
				i.setClass(SafetyCultureHJShowActivity.this,SafetyCultureHJHandleCardActivity.class);
				startActivity(i);
			}
		});
		getData(oper_id);
...
//		qx.setValueText(bean.getDefect_type());
		...
		xscontentBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				i.setClass(SafetyCultureHJShowActivity.this, DXSBXSKContentShowListActivity.class);
				startActivity(i);
			}
		});
