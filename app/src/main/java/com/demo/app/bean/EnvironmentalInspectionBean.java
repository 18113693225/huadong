 ...
 *
 */
public class EnvironmentalInspectionBean extends DateBean {
	// 主键id
		private int id ;
		// 项目名称 ，关联id
		...
		//环境选项 字符串类型
		private String environmental_options = "";
		//设备
		...
		public String getEnvironmental_options() {
			return environmental_options;
		}
		public void setEnvironmental_options(String environmental_options) {
			this.environmental_options = environmental_options;
		}
