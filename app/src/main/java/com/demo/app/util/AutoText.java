...
public class AutoText extends TextView {
	...
	public AutoText(Context context, AttributeSet set) {
		super(context, set);
		this.context = context;
		TypedArray typedArray = context.obtainStyledAttributes(set, R.styleable.AutoText);

		float textsize = typedArray.getDimension(R.styleable.AutoText_mytextSize, 20);
		int textcolor = typedArray.getColor(R.styleable.AutoText_mytextColor, -1442840576);
		float linespace = typedArray.getDimension(R.styleable.AutoText_lineSpacingExtra, -12);
		int typeface = typedArray.getColor(R.styleable.AutoText_typeface, 0);
